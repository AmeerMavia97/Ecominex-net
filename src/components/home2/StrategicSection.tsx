...
export default function StrategicSection() {
    ...
    return (
        <section className="w-full bg-[#111] pt-10 pb-20 ">
            ...
            >
                <div
                    className="absolute inset-0 rounded-[28px] w-[100%] h-[480px]"
                    style={{
                ...
                {active && (
                    <div
                        ...
                        aria-live="polite"
                    >
                        <h4 className="mb-3 text-xl font-extrabold">{active.label}</h4>
                    ...
                    {LOCATIONS.map((loc) => {
                        ...
                        return (
                            <button
                                ...
                                className={`rounded-2xl px-3 py-4 text-lg font-extrabold transition ${isActive

        ...
        <section className=" pt-10 pb-20 sm:py-20 text-white">
            <div className="">
                ...
                <div className="mt- grid grid-cols-1 gap-8 md:grid-cols-2 lg:mt-12 ">
                    ...
                    {/* Location Details */}
                    <div className="flex h-full flex-col items-center sm:items-start  overflow-hidden mt-7 ">
                        {/* Address Section */}
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start space-x-4 pb-6">
                            <Clock className="w-10 h-10 sm:h-12 sm:w-12 flex-shrink-0 mt-2.5 text-white bg-[#1c8337] px-2 py-2.5 rounded-full" />
                            <div className="text-center sm:text-start mt-2">
                        ...
                        <div className="flex   items-center sm:items-start space-x-2">
                            <div className="flex  flex-col justify-center items-center sm:items-start space-y-6">
                                <div className="flex flex-col sm:flex-row items-center sm:items-start space-x-4">
                                    <Mail className="w-10 h-10 sm:h-12 sm:w-12 mt-2.5 flex-shrink-0 text-white bg-[#1c8337] px-2 py-2.5 rounded-full" />
                                    <div className="text-center sm:text-start mt-2">
                                ...
                                <div className="flex flex-col sm:flex-row items-center sm:items-start space-x-4">
                                    <Phone className="w-10 h-10 sm:h-12 sm:w-12 mt-2.5 flex-shrink-0 text-white bg-[#1c8337] px-2 py-[11px] rounded-full" />
                                    <div className="text-center sm:text-start mt-2">
                        ...
                        <div className="relative w-full h-[40vh] mt-6">
                            <iframe
                    ...
                    <div className="relative h-full w-full overflow-hidden shadow-2xl bg-[#1b1b1b] rounded-[10px]">
                        <div className="">
                            <ToastContainer />
                            <div className=" rounded-lg bg-[#1a1a1a] px-9 py-12 shadow-xl">

                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="space-y-2">
                                        <label className="text-gray-100 font-[500] text-[15px] block">Full Name *</label>
                                        <input
                                            type="text"
                                            name="fullName"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-gray-100 font-[500] text-[15px] block">Email *</label>
                                        <input
                                            type="email"
                                            name="email"
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-gray-100 font-[500] text-[15px] block">Phone *</label>
                                            <input
                                                type="tel"
                                                name="phone"
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-gray-100 font-[500] text-[15px] block">Country</label>
                                            <input
                                                type="text"
                                                name="country"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-gray-100 font-[500] text-[15px] block">Description</label>
                                        <textarea
                                            name="description"
                                    ...
                                    <div className="flex justify-end">
                                        <button
                                            ...
                                            className="flex items-center justify-center gap-2 px-8 py-3 text-white text-[13.5px] font-[600] border border-green-500 rounded-full hover:bg-green-600 transition-all"
                                        >
